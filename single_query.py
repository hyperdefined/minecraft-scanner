...
def update_server_info(ip_address):
    ...
    try:
        ...
        protocol, server_software = minecraft_data['version']['protocol'], minecraft_data['version']['name']
        ...
        if len(ip_query) > 0:
            ...
            for index, row in ip_query.iterrows():
                ...
                minecraft_server_data.at[index, 'Forge'] = is_forge
                minecraft_server_data.at[index, 'Icon'] = icon   
